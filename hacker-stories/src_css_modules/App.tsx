...
const ItemList = ({ url, title, author, num_comments, points, onRemoveClicked, onEditClicked }: ItemListProps) => {
  return (
    <li className={styles.item}>
      ...
      <span style={{ width: '10%'}}>
        <button className={`${styles.button} ${styles.buttonSmall}`} onClick={onRemoveClicked}>Remove</button>
        <button className={`${styles.button} ${styles.buttonSmall}`} onClick={onEditClicked}>Edit</button>
      </span>
      <br />
      <br />
    </li>
...
const App = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.headlinePrimary}>My Hacker Stories 2</h1>
      <SimpleForm
