...
import { StyledSearchForm, StyleButtonLarge, StyledLabel, StyledInput } from "./styledComponents";
...
export const SimpleForm = ({ handleTriggerSearch, handleSearchTermChanged, searchTerm }: SimpleFormProps) => {
    ...
    return (
        <StyledSearchForm onSubmit={handleTriggerSearch}>
            <InputWithLabel
                id="search-term"
                value={searchTerm}
                type='text'
            ...
            <div style={{
                ...
                <StyleButtonLarge type='submit' disabled={!searchTerm}>Search</StyleButtonLarge>
            </div>
        </StyledSearchForm>
    )
}