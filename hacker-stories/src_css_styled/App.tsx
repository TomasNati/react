...
import { StyledColumn, StyledContainer, StyledHeadlinePrimary, StyledItem, StyleButtonSmall } from './styledComponents';
...
const ItemList = ({ url, title, author, num_comments, points, onRemoveClicked, onEditClicked }: ItemListProps) => {
  return (
    <StyledItem>
      <StyledColumn width='40%'><a href={url} target="_blank">{title}</a></StyledColumn>
      <StyledColumn width='30%'><p>Authors: {author}</p></StyledColumn>
      <StyledColumn width='30%'><p>Number of comments: {num_comments}</p></StyledColumn>
      <StyledColumn width='10%'><p>Points: {points}</p></StyledColumn>
      <StyledColumn width='10%'>
        <StyleButtonSmall onClick={onRemoveClicked}>Remove</StyleButtonSmall>
        <StyleButtonSmall onClick={onEditClicked}>Edit</StyleButtonSmall>
      </StyledColumn>
      <br />
      <br />
    </StyledItem>
...
const App = () => {
  ...
  return (
    <StyledContainer>
      <StyledHeadlinePrimary>My Hacker Stories 2</StyledHeadlinePrimary>
      <SimpleForm
